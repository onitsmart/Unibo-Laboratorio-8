...
{
    public class AggiornamentoDimensioneMetaCampoQuery
    {
    ...
    {
        public async Task<DimensioneCampo?> Query(AggiornamentoDimensioneMetaCampoQuery qry)
        {
